...
namespace cvt {
	/* LEVEL 1 */
		...
		void	BLAS::sgemv( const BLAS_ORDER order, const BLAS_TRANSPOSE TransA, const int M, const int N,
							   const float alpha, const float *A, const int lda,
							   const float *X, const int incX, const float beta,
							   float *Y, const int incY);
		void	BLAS::gbmv( const BLAS_ORDER order,
							  const BLAS_TRANSPOSE TransA, const int M, const int N,
							  const int KL, const int KU, const float alpha,
							  const float *A, const int lda, const float *X,
							  const int incX, const float beta, float *Y, const int incY);

		void	BLAS::ssymv( const BLAS_ORDER order, const BLAS_UPLO Uplo,
							   const int N, const float alpha, const float *A,
							   const int lda, const float *X, const int incX,
							   const float beta, float *Y, const int incY);
		void	BLAS::ssbmv( const BLAS_ORDER order, const BLAS_UPLO Uplo,
							   const int N, const int K, const float alpha, const float *A,
							   const int lda, const float *X, const int incX,
							   const float beta, float *Y, const int incY);
		void	BLAS::sspmv( const BLAS_ORDER order, const BLAS_UPLO Uplo,
							   const int N, const float alpha, const float *Ap,
							   const float *X, const int incX,
							   const float beta, float *Y, const int incY);
		void	BLAS::strmv( const BLAS_ORDER order, const BLAS_UPLO Uplo,
							   const BLAS_TRANSPOSE TransA, const BLAS_DIAG Diag,
							   const int N, const float *A, const int lda,
							   float *X, const int incX);
		void	BLAS::stbmv( const BLAS_ORDER order, const BLAS_UPLO Uplo,
							   const BLAS_TRANSPOSE TransA, const BLAS_DIAG Diag,
							   const int N, const int K, const float *A, const int lda,
							   float *X, const int incX);
		void	BLAS::stpmv( const BLAS_ORDER order, const BLAS_UPLO Uplo,
							   const BLAS_TRANSPOSE TransA, const BLAS_DIAG Diag,
							   const int N, const float *Ap, float *X, const int incX);
		void	BLAS::strsv( const BLAS_ORDER order, const BLAS_UPLO Uplo,
							   const BLAS_TRANSPOSE TransA, const BLAS_DIAG Diag,
							   const int N, const float *A, const int lda, float *X,
							   const int incX);
		void	BLAS::stbsv( const BLAS_ORDER order, const BLAS_UPLO Uplo,
							   const BLAS_TRANSPOSE TransA, const BLAS_DIAG Diag,
							   const int N, const int K, const float *A, const int lda,
							   float *X, const int incX);
		void	BLAS::stpsv( const BLAS_ORDER order, const BLAS_UPLO Uplo,
							   const BLAS_TRANSPOSE TransA, const BLAS_DIAG Diag,
							   const int N, const float *Ap, float *X, const int incX);

		void	BLAS::sger( const BLAS_ORDER order, const int M, const int N,
							  const float alpha, const float *X, const int incX,
					          const float *Y, const int incY, float *A, const int lda);
		void	BLAS::ssyr( const BLAS_ORDER order, const BLAS_UPLO Uplo,
							  const int N, const float alpha, const float *X,
							  const int incX, float *A, const int lda);
		void	BLAS::sspr( const BLAS_ORDER order, const BLAS_UPLO Uplo,
							  const int N, const float alpha, const float *X,
							  const int incX, float *Ap);
		void	BLAS::ssyr2( const BLAS_ORDER order, const BLAS_UPLO Uplo,
					           const int N, const float alpha, const float *X,
							   const int incX, const float *Y, const int incY, float *A,
						       const int lda);
		void	BLAS::sspr2( const BLAS_ORDER order, const BLAS_UPLO Uplo,
							   const int N, const float alpha, const float *X,
							   const int incX, const float *Y, const int incY, float *A);
		...
		/* single precision, float*/
		void BLAS::sgemm( const BLAS_ORDER Order, const BLAS_TRANSPOSE TransA,
							const BLAS_TRANSPOSE TransB, const int M, const int N,
							const int K, const float alpha, const float *A,
							const int lda, const float *B, const int ldb,
							const float beta, float *C, const int ldc);
		void BLAS::ssymm( const BLAS_ORDER Order, const BLAS_SIDE Side,
							const BLAS_UPLO Uplo, const int M, const int N,
							const float alpha, const float *A, const int lda,
							const float *B, const int ldb, const float beta,
							float *C, const int ldc);
		void BLAS::ssyrk( const BLAS_ORDER Order, const BLAS_UPLO Uplo,
							const BLAS_TRANSPOSE Trans, const int N, const int K,
							const float alpha, const float *A, const int lda,
							const float beta, float *C, const int ldc);
		void BLAS::ssyr2k( const BLAS_ORDER Order, const BLAS_UPLO Uplo,
							const BLAS_TRANSPOSE Trans, const int N, const int K,
							const float alpha, const float *A, const int lda,
							const float *B, const int ldb, const float beta,
							float *C, const int ldc);
		void BLAS::strmm( const BLAS_ORDER Order, const BLAS_SIDE Side,
							const BLAS_UPLO Uplo, const BLAS_TRANSPOSE TransA,
							const BLAS_DIAG Diag, const int M, const int N,
							const float alpha, const float *A, const int lda,
							float *B, const int ldb);
		void BLAS::strsm( const BLAS_ORDER Order, const BLAS_SIDE Side,
							const BLAS_UPLO Uplo, const BLAS_TRANSPOSE TransA,
							const BLAS_DIAG Diag, const int M, const int N,
							const float alpha, const float *A, const int lda,
							float *B, const int ldb);
