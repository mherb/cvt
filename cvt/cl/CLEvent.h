...
//			CLContext context() const;
		...
		private:
			CLUTIL_GETINFOTYPE( eventCommandQueue, CL_EVENT_COMMAND_QUEUE, cl_command_queue, _object, ::clGetEventInfo )
//			CLUTIL_GETINFOTYPE( eventContext, CL_EVENT_CONTEXT, cl_context, _object, ::clGetEventInfo )
	};
}
