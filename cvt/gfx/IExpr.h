...
namespace cvt {
...
#if 0
	/*
		( Expr1 + float ) + Image -> ( Expr1 + Image ) + float
	 */
	template<typename T1>
	IExprBinary<IExprBinary<T1,IExprImage,IEXPR_ADD>, IExprScalar, IEXPR_ADD> operator+( const IExprBinary<T1,IExprScalar,IEXPR_ADD>& expr1, const Image& img )
	{
		return IExprBinary<IExprBinary<T1,IExprImage,IEXPR_ADD>, IExprScalar, IEXPR_ADD>( IExprBinary<T1,IExprImage,IEXPR_ADD>( expr1.op1, IExprImage( img ) ), expr1.op2 );
	}

	/*
		( Expr1 + float ) - Image -> ( Expr1 + ( Image * -1 ) ) + float
	 */
	template<typename T1>
	IExprBinary<IExprBinary<T1,IExprBinary<IExprImage,IExprScalar,IEXPR_MUL>,IEXPR_ADD>, IExprScalar, IEXPR_ADD> operator-( const IExprBinary<T1,IExprScalar,IEXPR_ADD>& expr1, const Image& img )
	{
		return IExprBinary<IExprBinary<T1,IExprBinary<IExprImage,IExprScalar,IEXPR_MUL>,IEXPR_ADD>, IExprScalar, IEXPR_ADD>( IExprBinary<T1,IExprBinary<IExprImage,IExprScalar,IEXPR_MUL>,IEXPR_ADD>( expr1.op1, IExprBinary<IExprImage,IExprScalar,IEXPR_MUL>( IExprImage( img ), IExprScalar( -1.0f ) ) ), expr1.op2 );
	}
	 ...
	 */
	template<typename T1>
	IExprBinary<IExprBinary<T1,IExprImage,IEXPR_MUL>, IExprScalar, IEXPR_MUL> operator*( const IExprBinary<T1,IExprScalar,IEXPR_MUL>& expr1, const Image& img )
	{
		return IExprBinary<IExprBinary<T1,IExprImage,IEXPR_MUL>, IExprScalar, IEXPR_MUL>( IExprBinary<T1,IExprImage,IEXPR_MUL>( expr1.op1, IExprImage( img ) ), expr1.op2 );
	}
	...
	template<typename T1_1, typename T2_1, IExprType op_1>
	IExprBinary<IExprBinary<T1_1,T2_1,op_1>, IExprScalar, IEXPR_MUL> operator*( const IExprBinary<T1_1,T2_1,op_1>& expr1, float val )
	{
		return IExprBinary<IExprBinary<T1_1,IExprScalar,op_1>, IExprScalar,IEXPR_MUL>( expr1, IExprScalar( val ) );
	}
	 ...
	 */
	template<typename T1_1, typename T2_1, IExprType op_1>
	IExprBinary<IExprBinary<T1_1,T2_1,op_1>, IExprScalar, IEXPR_ADD> operator+( const IExprBinary<T1_1,T2_1,op_1>& expr1, float val )
	{
		return IExprBinary<IExprBinary<T1_1,T2_1,op_1>, IExprScalar,IEXPR_ADD>( expr1, IExprScalar( val ) );
	}
	 ...
	 */
	template<typename T1_1, typename T2_1, IExprType op_1>
	IExprBinary<IExprBinary<T1_1,T2_1,op_1>,IExprBinary<IExprScalar,IExprScalar,IEXPR_MUL>, IEXPR_ADD> operator-( const IExprBinary<T1_1,T2_1,op_1>& expr1, float val )
	{
		return IExprBinary<IExprBinary<T1_1,T2_1,op_1>, IExprScalar,IEXPR_ADD>( expr1, IExprScalar( -val ) );
	}
	/*
		IExpr * X
	 */
	template<typename T1_1, typename T1_2, IExprType op1, typename T2_1, typename T2_2, IExprType op2>
	IExprBinary<IExprBinary<T1_1,T1_2,op1>, IExprBinary<T2_1,T2_2,op2>, IEXPR_MUL> operator*( const IExprBinary<T1_1,T1_2,op1>& expr1, const IExprBinary<T2_1,T2_2,op2>& expr2 )
	{
		return IExprBinary<IExprBinary<T1_1,T1_2,op1>, IExprBinary<T2_1,T2_2,op2>, IEXPR_MUL>( expr1, expr2 );
	}
	 ...
	 */
	template<typename T1_1, typename T1_2, IExprType op1, typename T2_1, typename T2_2, IExprType op2>
	IExprBinary<IExprBinary<T1_1,T1_2,op1>, IExprBinary<T2_1,T2_2,op2>, IEXPR_ADD> operator+( const IExprBinary<T1_1,T1_2,op1>& expr1, const IExprBinary<T2_1,T2_2,op2>& expr2 )
	{
		return IExprBinary<IExprBinary<T1_1,T1_2,op1>, IExprBinary<T2_1,T2_2,op2>, IEXPR_ADD>( expr1, expr2 );
	}
	 ...
	 */
	template<typename T1_1, typename T1_2, IExprType op1, typename T2_1, typename T2_2, IExprType op2>
	IExprBinary<IExprBinary<T1_1,T1_2,op1>, IExprBinary<IExprBinary<T2_1,T2_2,op2>,IExprScalar,IEXPR_MUL>, IEXPR_ADD> operator-( const IExprBinary<T1_1,T1_2,op1>& expr1, const IExprBinary<T2_1,T2_2,op2>& expr2 )
	{
		return IExprBinary<IExprBinary<T1_1,T1_2,op1>, IExprBinary<IExprBinary<T2_1,T2_2,op2>,IExprScalar,IEXPR_MUL>, IEXPR_ADD>( expr1,  IExprBinary<IExprBinary<T2_1,T2_2,op2>,IExprScalar,IEXPR_MUL>( expr2, IExprScalar( -1.0f), IEXPR_MUL ) );
	}
